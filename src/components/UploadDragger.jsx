    ...
    return (
        ...
        >
            <div className="p-4">
                ...
                <p className="text-sm px-4">{title || 'Click or Drag image to this area'}<br />{pasteHint === '' ? null : pasteHint || <>or <span className="bg-slate-200 inline-block rounded-md px-1">{key}</span> <span className="bg-slate-200 inline-block rounded-md px-1">C</span> Paste here</>}</p>
