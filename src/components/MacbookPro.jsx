            ...
            <div className="macbook" style={{ width: `${ width }px`, height: `${ width * 969 / 1602 }px` }}>
                ...
                <div className='h-full w-full overflow-hidden bg-black'>
                    <div className="h-full w-full" style={style}>
                        <img src={img} alt="Screenshot preview inside Macbook Pro frame" className={cn("max-w-full max-h-full block min-h-full min-w-full object-center", fit === 'cover' && "object-cover", fit === 'contain' && "object-contain", fit === 'fill' && "object-fill")} />
                    </div>
                </div>
            </div>
        </div>
