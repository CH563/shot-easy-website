export default {
    ...
    whatCont1: 'Ayuda a crear imágenes increíbles agregando un buen fondo con su captura de pantalla y descargando una hermosa imagen que se puede compartir en Facebook, Twitter y foros web.',
    whatCont2: 'Los usuarios pueden descargar hermosas imágenes con el tamaño perfecto y buena calidad.',
    whatCont3: 'La herramienta Embellecedor de Capturas de Pantalla en Línea funciona bien en Windows, MAC, Linux, Chrome, Firefox, Edge y Safari.'
}